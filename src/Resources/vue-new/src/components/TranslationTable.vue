<template>
    ...
    <table class="table table-bordered table-striped grid-table" ref="translationTable">
        ...
        <tr>
            ...
            <th class="text-center" v-for="locale in locales" :key="locale" v-show="columnVisible(locale)">
                <b-form-checkbox v-model="editableColumns[locale]">
                    [{{ locale }}]
                    Editable
                </b-form-checkbox>
            </th>
        ...
        <tr>
            ...
            <th v-for="locale in locales" v-show="columnVisible(locale)" :key="locale">
        ...
        methods: {
            ...
            onChangeTranslationRow(data) {
                ...
                if ((data.index + 1) < this.translations.length) {
                    ...
                    this.focusCurrentRow(data.locale);
                    return;
                }
